...
from check import check_management
import logging
...
class library_management_system:
    '''
    LibraryManagementSystem orchestrates the interactions between different
...
if __name__ == "__main__":
    ...
    library_object = library_management_system("storage")
